                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="impact_details_left">
                            <div class="impact_details_img1">
                                <img src="img/events/event-2.jpg" width="100%" height="100%" alt="">
                            </div>
                            <div class="impact_details_content">
                                <p class="impact_details_sub_title">finance</p>
                                <ul class="list-unstyled impact_details_meta">
                                    <li><a href="" class="me-1"><i data-feather="clock"></i>21 Ashoj, 2078</a></li>
                                </ul>
                                <h3 class="impact_details__title">Call for 7th AGM(Annual General Meeting) of Bandipur Cable Car Company</h3>
                            </div>
