      ...
      <div class="modal-dialog">
            <div class="modal-content" >
                  ...
                  <div class="modal-body">    
                       ...
                       <img src="img/agm-notice.png" width="100%" alt="notice">         
                  </div>    
                ...
                <div class="d-flex justify-content-between align-items-center breaking-news">
                    ...
                    <a href="img/downloads/4th.pdf">4th AGM(Annual General Meeting) of Bandipur Cable Car
                        ...
                        <a href="downloads.php">2nd AGM(Annual General Meeting) of Bandipur Cable Car
                            ...
                            class="dot"></span> <a href="#">Registration of Siddha Gufa Ropeway Pvt.Ltd (2080/03/13)
                        </a>
                    </marquee>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-3 col-sm-12 lead-block">
                ...
                <p>Bandipur Cable Car and Queen Tower are welcome tourist destinations for the joint investment and
                    support of indigenous and expatriate Nepalis</p>
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12">
                        <div class="item-wrapper">
                            ...
                            <div class="content-wrapper">
                                ...
                                <p class="card-text mt-0">Bandipur Cable Car Expects atleast 5 lakhs vistors per annum
                                    visiting Bandipur village’s beauty.</p>
                            </div> <!-- .content-wrapper -->
                        </div> <!-- .item-wrapper -->
                    </div> <!-- .col-sm-6 -->
                    <div class="col-lg-6 col-sm-12 col-xs-12">
                        <div class="item-wrapper">
                            ...
                            <div class="content-wrapper">
                                ...
                                <p class="card-text mt-0">Cable Car expects to have 500 Passenger per hour from
                                    different location in Bandipur Village.</p>
                            </div> <!-- .content-wrapper -->
                        </div> <!-- .item-wrapper -->
                    </div> <!-- .col-sm-6 -->
                    ...
                    <div class="col-lg-6 col-sm-12 col-xs-12 mt-4">
                        <div class="item-wrapper">
                            ...
                            <div class="content-wrapper">
                                ...
                                <p class="card-text mt-0">Bandipur Cable Car land inside the hotel of Queen tower in
                                    Upper Station.</p>
                            </div> <!-- .content-wrapper -->
                        </div> <!-- .item-wrapper -->
                    </div> <!-- .col-sm-6 -->
...
<section id="about-us">
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-sm-12 col-xs-12">
                <div class="work-together__left" data-aos="fade-right" data-aos-easing="linear"
                    data-aos-duration="1000">
                    <div class="work-together__img-box">
                        <div class="work-together-shape-1"><img src="assets/images/shapes/work-together-shape-1.png"
                                alt=""></div>
                            ...
                            <div class="about__img-2">
                                ...
                                <div class="video-main">
                                    ...
                                    <a href="https://www.youtube.com/watch?v=NJ_GYRPHIeY&t=135s&ab_channel=BandipurCablecar"
                                        class="video video-popup mfp-iframe" data-lity><i class="icon-play"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-sm-12 col-lg-7">
                    <div class="info__one__topleft">
                        <div class="section-title text-left">
                            <h6 data-aos="fade-up" data-aos-duration="1000">welcome to our company</h6>
                            <h2 class="section-title__title" data-aos="fade-up" data-aos-duration="2000">Bandipur is a
                                sovereign investor company managing a diverse portfolio of assets in Tourism Sector</h2>
                        </div>
                    </div>
                </div>
...
<section id="features">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <p>We continuously evolve our business model to focus on our key strengths by collaborating with our
                    shareholder, developing our talent and entering world-class partnerships.</p>
            ...
            <div class="col-lg-3">
                <div class="single-logo" style="height:120px; border:1px solid #ff7800;">
                    <a href="" target="blank">
                        ...
                        <img src="img/partner_company/skywalk.png"
                            alt="Logo of Bandipur Skywalk and Recreation Pvt. Ltd.">
        ...
        <div class="brand-carousel owl-carousel">
            ...
            <div class="single-logo">
                <a href="" target="_blank">
                    ...
                    <img src="img/partner_company/chandra_nirman.png"
                        alt="Logo of Chandra Nirman Sewa Private Limited, Kathmandu">
                </a>
            </div>
            <!-- client single item -->
            <div class="single-logo">
                <a href="" target="_blank">
                    ...
                    <img src="img/partner_company/crspl_logo.png"
                        alt="Logo of Conveyor & ropeway services pvt.Ltd. , India ">
                </a>
            </div>
            <!-- client single item -->
            <div class="single-logo">
                    ...
                    <a href="https://gyanmandu.com/content/8790" target="_blank">
                        <div class="card">
                            ...
                            <div class="pic"> <img class="" src="img/news/ipo.jpeg" alt="">
                                <div class="date"> <span class="day">15</span> <span class="month">Chaitra</span> <span
                                        class="year">2079</span> </div>
                            </div>
                            <div class="content">
                                <h4 class="impact_heading">बन्दीपुर केबलकार एण्ड टुरिजमको आईपिओ निष्कासनको बिक्री
                                    प्रबन्धकमा नेपाल एसबिआई मर्चेण्ड बैँकिङ्ग लिमिटेड नियुक्त</h4>
                                <div class="d-flex align-items-center justify-content-between mt-3 pb-3">
                                    <a href="https://gyanmandu.com/content/8790" target="_blank"> Read More</a>
                                    <a href="https://gyanmandu.com/content/8790" target="_blank"
                                        class="impact_one_arrow"><i class="icon-long-arrow-right"></i></a>
                    ...
                    <a href="impact-details2.php">
                        <div class="card">
                            ...
                            <div class="pic"> <img class="" src="img/events/event-2.jpg" alt="">
                                <div class="date"> <span class="day">17</span> <span class="month">Sep</span> <span
                                        class="year">2021</span> </div>
                            </div>
                            <div class="content">
                                <h4 class="impact_heading">Call for 7th AGM(Annual General Meeting) of Bandipur Cable
                                    Car Company</h4>
                                <div class="d-flex align-items-center justify-content-between mt-3 pb-3">
                                    <a href="impact-details2.php"> Read More</a>
                                    <a href="impact-details2.php" class="impact_one_arrow"><i
                                            class="icon-long-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
