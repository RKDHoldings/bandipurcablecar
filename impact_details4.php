<?php
 ...
 <section id="breadcrumb">
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h2 class="breadcrumb-title">5th Annual General Meeting Decision of Bandipur Cable Car</h2>
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i>Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">5th Annual General Meeting Decision of Bandipur Cable Car</li>
                     </ol>
                  </nav>
               </div>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="impact_details_left">
                            <div class="impact_details_img1">
                                <img src="img/events/event-4.jpg" width="100%" height="100%" alt="">
                            </div>
                            <div class="impact_details_content">
                                <p class="impact_details_sub_title">finance</p>
                                <ul class="list-unstyled impact_details_meta">
                                    <li><a href="" class="me-1"><i data-feather="clock"></i>25 Magh, 2076</a></li>
                                </ul>
                                <h3 class="impact_details__title">5th Annual General Meeting Decision of Bandipur Cable Car</h3>
                                <p>Annual 5th General Meeting of Bandipur  Cable Car was held on 2076 Magh 25 in upper station.AGM Decision can be downloaded below</p>
                                <a href="https://drive.google.com/file/d/1BsD50LFkwGo0y7N5UpRuXH0XwnSKLuOg/view" target="_blank">  <button class="slide_from_left"> Download Here</button> </a>
                            </div>
