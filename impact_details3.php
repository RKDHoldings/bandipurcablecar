<?php
 ...
 <section id="breadcrumb">
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h2 class="breadcrumb-title">Bandipur Cable Car financial closure from Nepal SBI & NMB Bank</h2>
                  <nav aria-label="breadcrumb">
                     <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html"><i data-feather="home"></i>Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Bandipur Cable Car financial closure from Nepal SBI & NMB Bank</li>
                     </ol>
                  </nav>
               </div>
            </div>
                    ...
                    <div class="col-xl-8 col-lg-7">
                        <div class="impact_details_left">
                            <div class="impact_details_img1">
                                <img src="img/events/event-3.jpg" width="100%" height="100%" alt="">
                            </div>
                            <div class="impact_details_content">
                                ...
                                <h3 class="impact_details__title">Bandipur Cable Car financial closure from Nepal SBI & NMB Bank</h3>
                                <p>Two banks have done financial closure with Bandipur Cable Car Pvt.Ltd(BCCPL). Nepal SBI and NMB bank have agreed to invest in the bandipur cable car project.</p>
                                <p>A loan agreement has been signed between bandipur cable car, Tourism investment fund(Holding company of BCCPL) and the bank. As a banking partner, SBI and NMB have co-financed with each other. The agreement has been signed by Binod Dhungel, Chief Manager, Nepal SBI Bank and Vishal Thapa, Project Fiance Head, NMB Bank
                                   The cost of BCCPL is Rs 1 Arab and 68 crore. Equity to loan ratio for the construction of the project is 39:61. A total of Rs 700 million has been managed for the first phase of commerical operation by Ashwin
                                   end as told by Chairman of BCCPL. As per the loan split, 72.85 % will be disbursed by SBI and 27.14 % by  NMB Bank</p>
                            </div>
