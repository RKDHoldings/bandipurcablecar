...
<?php
 ...
 <section id="breadcrumb">
         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-12">
                  <h2 class="breadcrumb-title">media center</h2>
 ...
 <section id="media_center">
    <div class="container">
      <h6>press</h6>
      <h2 class="section-title">media release</h2>
          ...
          <div class="col-lg-4">
               ...
               <div class="col-lg-4">
                  ...
                  <div class="details">		
                        ...
                        title="Bandipur Cablecar ">यस्तो बन्दैछ बन्दिपुरको पहिलो पाँचतारे होटल </a></h3>
          ...
          <!-- new row -->
          <div class="row news_bottom" data-aos="fade-up" data-aos-duration="3000">
             <div class="col-lg-4">   
                <h3 class="news_heading">news updates</h3> 
          ...
          <div class="col-lg-4">
                  <h3 class="news_heading">all videos</h3> 
                  <ul class="video-list">
							       	<li>
                         	<div class="thumb">
					              	...
					              	<div class="details">
									   	...
									   	<li>			
					              	<div class="thumb">
							               <a title="Episode 3: Space" href="https://www.youtube.com/watch?v=Reo9yTqD9KA&ab_channel=BandipurCablecar"><span class="play"></span><img height="92" width="122" title="" alt="" src="img/news/agm.webp"></a>
					              	</div>
					              	<div class="details">
